...
public class HistoricoEntrega {
    ...
    public HistoricoEntrega(int id, int entregaId, Timestamp dataEvento, String descricao) {
        this.id = id;
    ...
    public HistoricoEntrega(int entregaId, Timestamp dataEvento, String descricao) {
        this.entregaId = entregaId;
        this.dataEvento = dataEvento;
        this.descricao = descricao;
    }
